    ...
    try {
        ...
        <table border="1" style="border-collapse: collapse; width: 100%;">
            ...
            <tr>
                ...
                <td style="padding: 8px;"></td>
                <td style="padding: 8px;">¥${orderData.shipping.toLocaleString()}</td>
            </tr>
            ${orderData.codFee > 0 ? `<tr>
                <td style="padding: 8px;">代引き手数料</td>
                <td style="padding: 8px;"></td>
                <td style="padding: 8px;">¥${orderData.codFee.toLocaleString()}</td>
            </tr>` : ''}
            <tr style="background-color: #f5f5f5;">
        ...
        <p>I am Beauty Store</p>
        `;

        const result = await resendClient.emails.send({
            from: process.env.FROM_EMAIL,
            to: [orderData.email],
            subject: `【I am Beauty Store】ご注文確認 - ${orderData.orderId}`,
            html: emailHtml
        });
